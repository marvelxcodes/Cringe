  ...
  return (
    <div className='w-full h-[calc(100vh-5rem)] flex justify-center items-center'>
        <div className='h-96 w-80 shadow-sm bg-purple-100 rounded-2xl select-none relative space-y-4 flex items-center flex-col'>
            ...
            <input type="text" className='px-5 outline-none rounded-full caret-purple-500 text-center w-[calc(100%-1.5rem)] h-10' placeholder='Enter a Title' />
            <input type="text" className='px-5 outline-none text-center caret-purple-500 rounded-full w-[calc(100%-1.5rem)] h-10' placeholder='Enter a Message' />
            <input type="file" className='text-purple-300 w-[calc(100%-1.5rem)] pl-10 flex ' placeholder='Select a Image' />
