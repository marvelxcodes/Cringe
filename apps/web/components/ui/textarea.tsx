...
import { TextField, TextArea as AriaTextArea, Label, type TextFieldProps } from 'react-aria-components';
...
const TextArea = forwardRef<HTMLTextAreaElement, TextAreaProps>(
  ({ label, placeholder, error, helperText, rows = 4, maxLength, showCount = false, className = '', ...props }, ref) => {
    return (
